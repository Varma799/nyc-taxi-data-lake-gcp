...
About the Developer:
Umapathi Varma is a Senior Data Engineer with over 6 years of experience designing and implementing ETL pipelines, lakehouse platforms, and analytics solutions across GCP, Azure, and AWS. This project demonstrates production-grade data engineering practices using PySpark, Terraform, and dbt to handle large-scale datasets efficiently.